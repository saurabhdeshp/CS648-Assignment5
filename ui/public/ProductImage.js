...
var _fetchGraphQL = _interopRequireDefault(require("./fetchGraphQL"));
...
var ProductImage = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(ProductImage, [{
    ...
    value: function render() {
      ...
      if (!id) {
        return /*#__PURE__*/_react.default.createElement("p", null, "Product with Id ".concat(id, " not present in the Database"));
      }

      if (!url) {
        return /*#__PURE__*/_react.default.createElement("p", null, "No Image Url set for Product with id ".concat(id));
      }

      return /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement("h3", null, "Viewing Image of - ".concat(name)), /*#__PURE__*/_react.default.createElement("img", {
        src: url,
